...
/**
 * This class test ElvesCatcher class and its relevant methods.
 * @author Yuanwei Lai
 */
public class ElvesCatcherTest extends TestCase {
    ArrayList<Skills> skillsList = new ArrayList<Skills>();
    private ElvesCatcher catcher=null;
     ...
     * @param testName
     */
    public ElvesCatcherTest(String testName) {
        super(testName);
    }
    ...
    public void testGetSt() {
        ...
        Assert.assertEquals(3, catcher.getSt());
    }
    ...
    public void testGetAg() {
        Assert.assertEquals(4, catcher.getAg());
    }
