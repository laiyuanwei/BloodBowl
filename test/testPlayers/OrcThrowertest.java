...
import bloodbowl.model.players.OrcThrower;
 ...
 * @author Yuanwei Lai
 */
public class OrcThrowertest extends TestCase {
    ArrayList<Skills> skillsList = new ArrayList<Skills>();
    private OrcThrower thrower=null;
     ...
     * @param testName
     */
    public OrcThrowertest(String testName) {
        super(testName);
    }
    ...
    protected void setUp() throws Exception {
        super.setUp();
       // skill=Skills.PASS;
        //thrower=new Thrower(1,2,3,4,10,skillsList,PlayerType.THROWER);
        thrower= new OrcThrower();
    ...
    public void testGetMaLeft(){
       Assert.assertEquals(5, thrower.getMa());
    }
    ...
    public void testDecreaseMovementLeft()
    {
        ...
        Assert.assertEquals(4, thrower.getMa()-1);
        //maLeft--;
    }
    /**
     * This is test set method.
  ...
  public void testGetActive() {
    ...
    public void testGetAv() {
        //return av;
        Assert.assertEquals(8, thrower.getAv());
    }
    ...
    public void testGetAg() {
        Assert.assertEquals(3, thrower.getAg());
    }
