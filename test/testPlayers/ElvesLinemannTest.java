 ...
 * @author Yuanwei Lai
 */
public class ElvesLinemannTest extends TestCase {
    ArrayList<Skills> skillsList = new ArrayList<Skills>();
    private ElvesLineman lineman=null;
     ...
     * @param testName
     */
    public ElvesLinemannTest(String testName) {
        super(testName);
    }
    ...
    public void testGetMaLeft(){
       Assert.assertEquals(6, lineman.getMa());
    }
    ...
    public void testDecreaseMovementLeft()
    {
        ...
        Assert.assertEquals(5, lineman.getMa()-1);
  ...
  public void testGetActive() {
    ...
    public void testGetAv() {
        ...
        Assert.assertEquals(7, lineman.getAv());
    }
    ...
    public void testGetAg() {
        Assert.assertEquals(4, lineman.getAg());
    }
