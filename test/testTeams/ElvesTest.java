...
/**
 * This class test Elves class and its relevant methods.
 * @author Yuanwei Lai
 */
public class ElvesTest extends TestCase {
  ...
  /*****************************Player count getters***********************/
    ...
    {
        int turn=elves.getTurns()-1;
        elves.turnComplete();
        if(elves.getTurns()>0)
          {
            Assert.assertEquals(turn, elves.getTurns());
           }
        Assert.assertEquals(false,elves.getPlayerHasMadePass());
    }
    ...
    public void testPassMade(){
       elves.passMade();
       Assert.assertTrue(elves.getPlayerHasMadePass());
    }
    ...
    public void testIsValidPlayerAddition(){
      boolean b=elves.isValidPlayerAddition(PlayerType.BLACKORC);
    ...
    public void testAddPlayer(){
     ...
     elves.initializePlayers();
     elves.addPlayer(blitzer);
     Assert.assertTrue(elves.getTotalPlayers()==1);
    }
}
